                      ...
                      <td>
                        ...
                        <div v-else>
                          <span
                            ...
                            >win</span
                          >
                          <span v-else class="badge bg-danger text-light"
                            >lose</span
                          >
                        </div>
                      </td>
...
export default {
  ...
  created() {
    ...
    this.axios
      ...
      this.axios
        .get(
          `http://localhost/latihan_lelang/public/api/history/${this.$route.params.id}`,
          {
            headers: { Authorization: "Bearer" + this.$store.state.token },
          }
        )
  ...
  methods: {
    pilih(id_history) {
      this.axios
        .put(
          `http://localhost/latihan_lelang/public/api/history/pemenang/${id_history}`,
          this.lelang,
          {
            headers: { Authorization: "Bearer" + this.$store.state.token },
          }
        ...
        .then(() => {
          ...
          this.$swal({
            title: "Success",
            text: "The winner has been selected, the auction will be closed automatically",
          });
        })
        .catch((err) => console.log(err));
    },
