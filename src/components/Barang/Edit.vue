                ...
                <form @submit.prevent="edit" class="forms-sample">
                  ...
                  <div class="form-group">
                    ...
                    <input
                      type="text"
                      class="form-control"
                      id="exampleInputHarga1"
                      v-model="barang.harga_awal"
                    />
                  </div>
                  <div class="form-group">
...
export default {
  ...
  created() {
    ...
    this.axios
      .get(
        `http://localhost/latihan_lelang/public/api/barang/${this.$route.params.id}`,
        {
