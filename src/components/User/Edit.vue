            ...
            <div class="card-body">
              ...
              <form @submit.prevent="edit" class="forms-sample">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputAlamat1" placeholder="Address" v-model="user.alamat">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Username" v-model="user.username">
                </div>
                <div class="form-group">
...
<script>
    export default {
        ...
        created(){
            this.axios.get(`http://localhost/latihan_lelang/public/api/show/${this.$route.params.id}`,
            {
        ...
        methods : {
            edit() {
                this.axios.put(`http://localhost/latihan_lelang/public/api/edit/${this.$route.params.id}`, this.user,{
                headers : { Authorization : 'Bearer' + this.$store.state.token}
            })
                .then(()=>{
